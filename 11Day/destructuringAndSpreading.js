...
for(let {name,scores,skills,age} of users){
    let c = Object.keys({name,scores,skills,age});
    b.push(c);
};
...
for(let {name,capital,languages,population,flag,currency} of g){
    let f = languages.join(',');    
    console.log(name,capital,population,f);
}

const student = ['David', ['HTM', 'CSS', 'JS', 'React'], [98, 85, 90, 95]];

let [namee,skillss,[,,jsScore,reactScore]] = student;

console.log(namee,skillss,jsScore,reactScore);
...
let convertArrayToObject = function (as){
    let a = [];
    for(let [name,skills,scores] of as){
...
let newStudent = {...studentsss};

let newStudente = function(){
